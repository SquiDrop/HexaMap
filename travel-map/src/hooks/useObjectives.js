...
export const PRESET_CHALLENGES = [
  ...
  { id: "cat_ski_2",         type: "categorie", label: "Skieur",                description: "2 journées de ski",                  target: 2,  unit: "lieux", categoryName: "Journées de ski" },
  { id: "cat_ski_5",         type: "categorie", label: "Roi de la glisse ⛷️",   description: "5 journées de ski",                  target: 5,  unit: "lieux", categoryName: "Journées de ski" },
  { id: "cat_montagne_2",    type: "categorie", label: "Montagnard",            description: "2 lieux Montagne",                   target: 2,  unit: "lieux", categoryName: "Montagne" },
  { id: "cat_montagne_5",    type: "categorie", label: "Conquérant des sommets 🏔️", description: "5 lieux Montagne",               target: 5,  unit: "lieux", categoryName: "Montagne" },
  ...
  { id: "cat_cepes_5",       type: "categorie", label: "Chasseur de champis 🍄",     description: "5 lieux Coins à cèpes",               target: 5,  unit: "lieux", categoryName: "Coins à champignon" },
  // — Géographiques —
